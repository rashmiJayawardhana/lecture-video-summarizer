...
INPUT_FILE  = "src/module2_summarization/final_output/LecVideo_033_module2_final.json"
OUTPUT_FILE = "src/module2_summarization/final_output/LecVideo_033_enriched.json"
