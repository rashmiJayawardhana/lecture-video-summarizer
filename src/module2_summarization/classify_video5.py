...
INPUT_FILE      = "src/module2_summarization/json_output/LecVideo_005_-_#Security_of_#Information_#Systems_-_Lecture_1___Information_Security_Basic_Concepts.json"
OUTPUT_FILE     = "src/module2_summarization/final_output/LecVideo_005_module2_final.json"
# ──────────────────────────────────────────────────────────
...
IT_KEYWORDS = [
    ...
    "cryptography", "vulnerability", "threat", "attack", "malware",
    "virus", "firewall", "risk", "privacy", "access control",
    "protocol", "hash", "CIA triad", "principle", "asset",
    "countermeasure", "policy", "governance", "audit", "compliance",
    "algorithm", "network", "system", "data", "information"
]
...
print(f"\nProcessing Video 005 - Security Basics")
