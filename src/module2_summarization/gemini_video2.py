...
# Settings
INPUT_FILE  = "src/module2_summarization/final_output/LecVideo_002_module2_final.json"
OUTPUT_FILE = "src/module2_summarization/final_output/LecVideo_002_enriched.json"
...
for i, block in enumerate(blocks):
    ...
    prompt = f"""Analyze this SQL/database lecture excerpt. Return ONLY valid JSON with:
...
Return only JSON, no markdown."""
    ...
    time.sleep(6)  # 6 seconds between calls = 10/min = safe!
