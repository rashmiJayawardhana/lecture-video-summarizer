...
INPUT_FILE      = "src/module2_summarization/json_output/LecVideo_033_-_Lesson_09_-_HTA_-_Human_Computer_Interaction.json"
OUTPUT_FILE     = "src/module2_summarization/final_output/LecVideo_033_module2_final.json"

os.makedirs("src/module2_summarization/final_output", exist_ok=True)

print("Loading BERT v4 (F1=0.74)...")
tokenizer = BertTokenizer.from_pretrained(BERT_MODEL_PATH)
model = BertForSequenceClassification.from_pretrained(BERT_MODEL_PATH)
model.eval()
print("BERT v4 loaded!")

# HCI-focused keywords
IT_KEYWORDS = [
    "hci", "human", "computer", "interaction", "interface", "usability",
    "user", "experience", "design", "task", "analysis", "hta",
    "hierarchical", "cognitive", "goal", "subtask", "workflow",
    "prototype", "evaluation", "heuristic", "guideline", "principle",
    "system", "algorithm", "process", "method", "model",
    "information", "data", "computer", "software", "requirement"
]
